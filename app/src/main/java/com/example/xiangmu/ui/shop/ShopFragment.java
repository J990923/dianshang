...
import com.example.xiangmu.presenter.shop.CarPresenter;
import com.example.xiangmu.ui.location.LocationActivity;
...
public class ShopFragment extends BaseFragment<ICar.Presenter> implements ICar.View, View.OnClickListener {
    ...
    private ShopAdapter carListAdapter;
    ...
    protected void initData() {
        list = new ArrayList<>();
        carListAdapter = new ShopAdapter(mContext,list);
        ...
        // 监听编辑状态下item的数据变化
        carListAdapter.setUpdateItem(new ShopAdapter.UpdateItem() {
            @Override
